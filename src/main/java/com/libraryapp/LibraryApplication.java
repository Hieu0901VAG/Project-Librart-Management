...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("test"), "hieunguyen@gmail.com", "Hieu", "Nguyen", "Truong Dinh", "0898704429", "Ha Noi");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("employee", pwEncoder.encode("test"), "hieundm@gamail.com", "Hiu", "ndm", "Back Khoa", "06-87054875", "Ha Noi");
			user2.setRole("ROLE_EMPLOYEE");
			
			User user3 = new User("user", pwEncoder.encode("test"), "kevin@gmail.com", "Kevin", "Le", "Thanh Nhan", "06-18756892", "Hai Phong");
			user3.setRole("ROLE_USER");	
			User user4 = new User("aniemies", pwEncoder.encode("test"), "annemie.schuurbiers@gmail.com", "Annemie", "Schuurbiers", "Tan Mai", "06-83472443", "Ha Noi");
			User user5 = new User("ronaldo", pwEncoder.encode("test"), "ronaldo@gmail.com", "Ronaldo", "Cristiano", "Minh Khai", "06-13644621", "Quang Ninh");
			User user6 = new User("beukenplein", pwEncoder.encode("test"), "m.snel@gmail.com", "Mikael", "Snel", "Back Khoa", "06-90982738", "Ha Noi");
			User user7 = new User("bookwurm", pwEncoder.encode("test"), "bookwurm@gmail.com", "Martina", "Jansen", "Truong Dinh", "06-00492182", "Thanh Hoa");
			User user8 = new User("daniela45", pwEncoder.encode("test"), "d.peerdeman@gmail.com", "Daniela", "Peerdeman", "Phuong Liet", "06-88720394", "Bac Giang");
			User user9 = new User("blackandyellow", pwEncoder.encode("test"), "simons@gmail.com", "Gert", "Simons", "Minh Khai", "06-18392031", "Bac Ninh");
			User user10 = new User("superman123", pwEncoder.encode("test"), "edo.vandeijck@gmail.com", "Edo", "van Deijck", "Bach Mai", "06-98374821", "Ha Noi");
